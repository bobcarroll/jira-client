...
public class JiraClient {
   ...
   */
  public JiraClient(String uri) throws JiraException { this(null, uri, null); }
   ...
   * @throws JiraException
   */
  public JiraClient(HttpClient httpClient, String uri, ICredentials creds)
      throws JiraException {
    if (httpClient == null) {
   ...
   * @throws JiraException when something goes wrong
   */
  public Issue getIssue(String key, String includedFields, String expand)
      throws JiraException {
  ...
  public Issue.SearchResult searchIssues(String jql, String includedFields,
    ...
    return Issue.search(restclient, jql, includedFields, expandFields,
                        maxResults, startAt);
  }
  ...
  public List<Priority> getPriorities() throws JiraException {
    try {
      ...
      List<Priority> priorities =
          new ArrayList<Priority>(prioritiesArray.size());
   ...
   * @throws JiraException when the search fails
   */
  public List<CustomFieldOption>
  getCustomFieldAllowedValues(String field, String project, String issueType)
      throws JiraException {
    ...
    List<CustomFieldOption> customFieldOptions =
        Field.getResourceArray(CustomFieldOption.class,
                               fieldMetadata.get("allowedValues"), restclient);
   ...
   * @throws JiraException when the search fails
   */
  public List<Component> getComponentsAllowedValues(String project,
                                                    String issueType)
      throws JiraException {
    JSONObject createMetadata =
        (JSONObject)Issue.getCreateMetadata(restclient, project, issueType);
    ...
    List<Component> componentOptions = Field.getResourceArray(
        Component.class, fieldMetadata.get("allowedValues"), restclient);
    return componentOptions;
  }

  public RestClient getRestClient() { return restclient; }

  public String getSelf() { return username; }
  ...
  public List<IssueType> getIssueTypes() throws JiraException {
    try {
      ...
      List<IssueType> issueTypes =
          new ArrayList<IssueType>(issueTypeArray.size());
  ...
  public ArrayList<IssueHistory> filterChangeLog(List<IssueHistory> histoy,
                                                 String fields) {
  ...
  public ArrayList<IssueHistory> getIssueChangeLog(Issue issue)
      throws JiraException {
    try {
  ...
  private JSON getNextPortion(Issue issue, Integer startAt)
    ...
    URI uri =
        restclient.buildURI(Issue.getBaseUri() + "issue/" + issue.id, params);
